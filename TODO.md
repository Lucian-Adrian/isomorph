...
- [x] `npm test -- --run`: 504 passing, 0 failing, 31 test files.
...
- [x] Update `README.md` test badge and testing section from 438 to 504 passing.
- [x] Update `docs/qa/isomorph-release-handoff.md` with the 504-test snapshot and current bundle chunk sizes.
