...
- [x] `npm run build`: passed.
  - Current production output: `index-9wthjR_o.js` 389.64 kB, `vendor-editor-CKufDpsk.js` 357.24 kB, `vendor-supabase-Cp1pO4X2.js` 204.43 kB, `vendor-react-CIlLrotA.js` 138.64 kB.
...
- [x] Refresh README/release-handoff test counts and bundle-size notes from the current 504-test/389.64 kB snapshot.
...
- [ ] Run a bundle analyzer/source-map review before final deployment; current app chunk is 389.64 kB after the latest feature work.
...
- Bundle size improved structurally but needs a hard CI budget; the current main app chunk has grown to 389.64 kB.
